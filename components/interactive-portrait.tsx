...
export default function InteractivePortrait() {
  ...
  useEffect(() => {
    ...
    const baseTexture = textureLoader.load("/spacesuit/visor-off.png", (texture) => {
    ...
    const helmetTexture = textureLoader.load("/spacesuit/visor-on.png")
  ...
  return (
    ...
    >
      <div className="absolute bottom-4 left-4 z-10 pointer-events-none bg-black/50 backdrop-blur-sm rounded-lg px-3 py-2">
        <p className="text-white/60 text-xs font-medium">Head of Growth @ GroundCtrl</p>
        <p className="text-lorenzo-accent text-xs font-bold">Founder @ Born & Brand</p>
      </div>
    </div>
  )
}
